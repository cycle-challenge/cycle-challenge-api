...
@Service
public class TravelBookmarkFindService extends BookmarkFindService<TravelBookmark> {

    public TravelBookmarkFindService(TravelBookmarkRepository bookmarkRepository,
